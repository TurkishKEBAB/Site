...
const t = {
  tr: {
    ...
    placeholders: {
      ...
      message: "Mesajinizi buraya yazabilirsiniz..."
    },
    buttons: {
    ...
    validation: {
      nameMin: "Lutfen en az 2 karakter girin.",
      emailInvalid: "Lutfen gecerli bir e-posta adresi girin.",
      subjectMin: "Konu en az 3 karakter olmali veya bos birakilmalidir.",
      messageMin: "Mesajiniz en az 10 karakterden olusmalidir."
    },
    toast: {
      fixErrors: "Lutfen gondermeden once hatali alanlari duzeltin.",
      success: "Mesajiniz basariyla gonderildi!",
      errorFallback: "Mesaj gonderilemedi. Lutfen daha sonra tekrar deneyin."
    },
    info: {
      ...
      responseTimeValue: "Genellikle 24 saat icinde donus yaparim."
    },
    promo: {
      title: "Yeni Muhendislik Is Birliklerine Acigim",
      text: "Ozellikle backend sistemleri, cloud-native mimari, otomasyon ve urunlestirme odakli projelerde teknik katki ve ekip calismasina acigim."
    }
  },
  en: {
    ...
    info: {
      ...
      responseTimeValue: "I usually respond within 24 hours."
    },
    promo: {
      title: "Open to Engineering Collaborations",
      text: "I am open to collaboration on backend systems, cloud-native architecture, automation pipelines, and product-focused software delivery."
    }
  }
} as const;
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  {...(errors.name && { 'aria-invalid': true, 'aria-describedby': 'name-error' })}
                   className="w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-dark-600 bg-white dark:bg-dark-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-primary-500 focus:border-primary-500 outline-none transition-all duration-200"
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={6}
                   className="w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-dark-600 bg-white dark:bg-dark-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-primary-500 focus:border-primary-500 outline-none transition-all duration-200 resize-none"
          ...
          >
            ...
            <div className="bg-gradient-to-br from-primary-600 to-primary-600 rounded-2xl shadow-xl p-8 text-white">
              ...
              <div className="flex space-x-4">
                <a href="https://github.com/TurkishKEBAB" target="_blank" rel="noopener noreferrer" className="bg-white/20 hover:bg-white/30 p-3 rounded-full transition-all duration-300 hover:scale-110" title="GitHub">
                ...
                <a href="https://www.linkedin.com/in/yiğit-okur-050b5b278" target="_blank" rel="noopener noreferrer" className="bg-white/20 hover:bg-white/30 p-3 rounded-full transition-all duration-300 hover:scale-110" title="LinkedIn">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
