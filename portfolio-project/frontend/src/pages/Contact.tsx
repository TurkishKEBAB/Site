          ...
          >
            ...
            <div className="bg-gradient-to-br from-primary-600 to-primary-600 rounded-2xl shadow-xl p-8 text-white">
              ...
              <div className="flex space-x-4">
                ...
                <a href="https://www.linkedin.com/in/yigit-okur-050b5b278" target="_blank" rel="noopener noreferrer" className="bg-white/20 hover:bg-white/30 p-3 rounded-lg transition" title="LinkedIn">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
