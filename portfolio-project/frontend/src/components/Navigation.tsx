  ...
  return (
    <motion.nav
      ...
      className={`fixed w-full z-50 transition-all duration-300 ${
        scrolled
          ? 'bg-white/90 dark:bg-dark-900/90 backdrop-blur-md shadow-sm dark:shadow-lg'
          : 'bg-transparent'
      }`}
    >
        ...
        <div className="flex justify-between items-center h-16 md:h-20">
          ...
          <div className="flex items-center space-x-4">
            ...
            <motion.button
              ...
              className="md:hidden p-2 rounded-full bg-gray-100 dark:bg-dark-700 text-gray-600 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-dark-600 transition-colors"
