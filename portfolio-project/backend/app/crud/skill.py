...
def get_skills(
    ...
    return [_apply_skill_translation(skill, language, db) for skill in skills]
...
def get_skill_by_id(
    ...
    return _apply_skill_translation(skill, language, db)
...
def get_skills_count(
    ...
    """Get total count of skills using a proper COUNT query."""
