...
def _apply_project_translation(
    project: Project,
...
def get_projects(
    ...
    return [_apply_project_translation(project, language, db) for project in projects]
...
def get_project_by_slug(db: Session, slug: str, language: Optional[str] = "en") -> Optional[Project]:
    ...
    return _apply_project_translation(project, language, db)
