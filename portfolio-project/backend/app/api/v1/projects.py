...
async def upload_project_image(
    ...
    # Validate actual file size (file.size can be None / inaccurate)
    ...
    is_content_valid, content_error = storage_service.validate_file_content(file_content)
    ...
    safe_name = os.path.basename(file.filename or "upload.jpg").lstrip(".")
    if not safe_name:
        safe_name = "upload.jpg"

    # Upload to storage
    file_path = f"projects/{project_id}/{uuid.uuid4().hex}_{safe_name}"
